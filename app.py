# continued from basic_2.ipynb
# Date: 14/09/2022  15/09/20222
#
...
class Pro:
    def signup(self):
        ...
        # add image
        self.img = Image.open(r'./images/img.jpg')
        ...
        # buttons
        self.l5 = Label(self.root, text="course", font=("Times New Roman", 14))
        self.l5.place(relx=0.3, rely=0.60)

        # Combobox

        self.lst = ['Btech', 'BCA', 'Mtech', 'MBA']
        self.v3 = StringVar()
        self.v3.set('Select')
        self.combo = ttk.Combobox(
            self.root, textvariable=self.v3, values=self.lst)
        self.combo.place(relx=0.45, rely=0.6)
        self.bt1 = Button(self.root, text="Signup", width=10, bg="#a5ebf4",
                          font=("Times New Roman", 12), command=sig)
        self.bt1.place(relx=0.3, rely=0.68)

        self.bt2 = Button(self.root, text="Already have an account?", width=25, bg="#a5ebf4",
                          font=("Times New Roman", 12), command=fxn)
        self.bt2.place(relx=0.45, rely=0.68)
    ...
    def login(self):
        ...
        self.v1 = 0
        self.c1 = Checkbutton(self.root1, text='I agree',
                              variable=self.v1, onvalue=1, offvalue=0)
        self.c1.place(relx=0.3, rely=0.44)
